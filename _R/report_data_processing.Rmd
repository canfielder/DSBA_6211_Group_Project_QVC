...
qvc_data_1 <- read_xlsx("./data_R/QVC Data 1.xlsx", na = c("NA", ""))

qvc_data_2 <- read_xlsx("./data_R/QVC Data 2.xlsx", na = c("NA", ""))

qvc_data_3 <- read_xlsx("./data_R/QVC Data 3.xlsx", na = c("NA", ""))

qvc_distctr <- read_xlsx("./data_R/QVCdist_ctr.xlsx", na = c("NA", "")) 

qvc_orderstatustype <- read_xlsx("./data_R/QVCorderstatustype.xlsx", na = c("NA", ""))
```
...
```{r}
us_census_2018 <- read.csv("./data_R/us_census_population_change_2018_reformatted.csv")
```
